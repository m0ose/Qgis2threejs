...
//    console.log(editorCamera.position.toArray());
	...
	function prepareAnimationData( object, focusPoint ) {
		...
		switch ( object.userData.type ) {
			...
			case 'posX':
				...
				targetQuaternion.setFromEuler( new THREE.Euler( Math.PI * 0.5, Math.PI * 0.5, 0 ) );	//
				break;

			case 'posY':
				targetPosition.set( 0, 1, 0 );
				targetQuaternion.setFromEuler( new THREE.Euler( - Math.PI * 0.5, 0, Math.PI ) );	//
				break;
